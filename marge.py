...
# ==========================================
# HIDE STREAMLIT CROWN ICON & VIEWER BADGE
# ==========================================
hide_streamlit_icons = """
    <style>
    /* Hide Profile Avatar, Red Crown Icon, and Footer */
...
if st.session_state["active_mode"] == "URJAS":
    ...
    default_zones = [
        "ANNAPURNA", "GUMASTA NAGAR", "Hawa Bangla", "RAJ MOHALLA",
        "RAJENDRA NAGAR", "RAU", "SILICON CITY", "Sirpur"
    ]
    
    with col_b:
        zones = st.multiselect(
            "🏢 Select / Add Target Zones (Up to 15 or more):",
            options=default_zones + ["ZONE 9", "ZONE 10", "ZONE 11", "ZONE 12", "ZONE 13", "ZONE 14", "ZONE 15"],
    ...
    if uploaded_file:
        if not zones:
            st.warning("⚠️ Please select at least one zone to generate the report.")
        else:
            try:
